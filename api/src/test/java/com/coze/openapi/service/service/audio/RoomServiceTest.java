...
class RoomServiceTest {
    ...
    @Mock
    private AudioRoomAPI audioRoomAPI;

    @Mock
    private Call<BaseResponse<CreateRoomResp>> createCall;
    ...
    void testCreate() throws Exception {
        ...
        CreateRoomResp createResp = CreateRoomResp.builder()
                .roomID("room_id")
                .build();

        BaseResponse<CreateRoomResp> baseResponse = BaseResponse.<CreateRoomResp>builder()
                .code(0)
                .msg("success")
