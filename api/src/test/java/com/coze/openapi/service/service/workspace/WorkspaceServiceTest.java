...
class WorkspaceServiceTest {
    ...
    void testListWorkspaces() throws Exception {
        ...
        int pageNum = 1;
        int pageSize = 2;
        ListWorkspaceReq req = ListWorkspaceReq.builder()
                .pageNum(pageNum)
                .pageSize(pageSize)
                .build();
        ...
        ListWorkspaceResp respData = ListWorkspaceResp.builder()
                .workspaces(workspaces)
                .totalCount(5)  // 总共5条数据
                .build();

        BaseResponse<ListWorkspaceResp> baseResponse = BaseResponse.<ListWorkspaceResp>builder()
                .code(0)
                .msg("success")
    ...
    void testListWorkspacesLastPage() throws Exception {
        ...
        List<Workspace> workspaces = Arrays.asList(
                Workspace.builder().id("workspace3").name("工作空间3").build()
        );
        ...
        // 创建 mock Call 对象
        Call<BaseResponse<ListWorkspaceResp>> call = mock(Call.class);
        when(workspaceAPI.list(any(), any(), any()))
                .thenReturn(call);
        when(call.execute()).thenReturn(Response.success(baseResponse, Utils.getCommonHeader()));
