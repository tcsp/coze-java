...
class BotServiceTest {
    ...
    @Mock
    private Call<BaseResponse<ListBotResp>> listCall;
    
    @Mock
    private Call<BaseResponse<Bot>> retrieveCall;
    
    @Mock
    private Call<BaseResponse<CreateBotResp>> createCall;
    
    @Mock
    private Call<BaseResponse<Void>> updateCall;
    
    @Mock
    private Call<BaseResponse<PublishBotResp>> publishCall;
    ...
    public void testList() throws Exception {
        ...
        // 模拟返回数据
        List<SimpleBot> bots = Arrays.asList(
                SimpleBot.builder().botID("bot1").botName("Bot 1").build(),
                SimpleBot.builder().botID("bot2").botName("Bot 2").build()
        );
        
        ListBotResp listBotResp = ListBotResp.builder()
                .total(2)
                .bots(bots)
                .build();
                
        BaseResponse<ListBotResp> baseResponse = BaseResponse.<ListBotResp>builder()
                .code(0)
                .msg("success")
        ...
        // 设置 mock 行为
        when(botAPI.list(eq(spaceId), eq(1), eq(20), any(ListBotReq.class)))
                .thenReturn(listCall);
    ...
    void testRetrieve() throws Exception {
        ...
        RetrieveBotReq req = RetrieveBotReq.builder()
                .botID(botId)
                .build();
        ...
        BaseResponse<Bot> baseResponse = BaseResponse.<Bot>builder()
                .code(0)
                .msg("success")
                .logID(Utils.TEST_LOG_ID)
                .data(bot)
        ...
        // 设置 mock 行为
        when(botAPI.retrieve(eq(botId), any(RetrieveBotReq.class)))
                .thenReturn(retrieveCall);
        when(retrieveCall.execute()).thenReturn(Response.success(baseResponse, Utils.getCommonHeader()));
    ...
    void testCreate() throws Exception {
        // 准备测试数据
        CreateBotReq req = CreateBotReq.builder()
                .name("New Bot")
                .spaceID("mock_space_id")
                .build();

        CreateBotResp createResp = CreateBotResp.builder()
                .botID("new_bot_id")
                .build();

        BaseResponse<CreateBotResp> baseResponse = BaseResponse.<CreateBotResp>builder()
                .code(0)
                .msg("success")
                .logID(Utils.TEST_LOG_ID)
                .data(createResp)
        ...
        // 设置 mock 行为
        when(botAPI.create(any(CreateBotReq.class), any(CreateBotReq.class)))
    ...
    void testUpdate() throws Exception {
        // 准备测试数据
        UpdateBotReq req = UpdateBotReq.builder()
                .botID("bot_id")
                .name("Updated Bot")
                .build();
        ...
        // 设置 mock 行为
        when(botAPI.update(any(UpdateBotReq.class), any(UpdateBotReq.class)))
    ...
    void testPublish() throws Exception {
        // 准备测试数据
        PublishBotReq req = PublishBotReq.builder()
                .botID("bot_id")
                .build();

        PublishBotResp publishResp = PublishBotResp.builder()
                .botID("bot_id")
                .build();

        BaseResponse<PublishBotResp> baseResponse = BaseResponse.<PublishBotResp>builder()
                .code(0)
                .msg("success")
                .logID(Utils.TEST_LOG_ID)
                .data(publishResp)
