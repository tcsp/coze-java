...
class ConversationServiceTest {
    ...
    void testCreate() throws Exception {
        ...
        BaseResponse<Conversation> baseResponse = BaseResponse.<Conversation>builder()
                .code(0)
                .msg("success")
    ...
    void testList() throws Exception {
        ...
        ListConversationReq req = ListConversationReq.builder()
                .botID(botId)
                .pageNum(1)
                .pageSize(10)
                .build();
        ...
        List<Conversation> conversations = Arrays.asList(
                Conversation.builder().id("conv1").build(),
                Conversation.builder().id("conv2").build()
        );

        ListConversationResp listResp = ListConversationResp.builder()
                .conversations(conversations)
                .hasMore(false)
                .logID(Utils.TEST_LOG_ID)
                .build();

        BaseResponse<ListConversationResp> baseResponse = BaseResponse.<ListConversationResp>builder()
                .code(0)
                .msg("success")
                .logID(Utils.TEST_LOG_ID)
                .data(listResp)
    ...
    void testRetrieve() throws Exception {
        ...
        RetrieveConversationReq req = RetrieveConversationReq.builder()
    ...
    void testClear() throws Exception {
        // 准备测试数据
        String conversationId = "test_conversation_id";
        ClearConversationReq req = ClearConversationReq.builder()
                .conversationID(conversationId)
                .build();

        ClearConversationResp clearResp = ClearConversationResp.builder()
                .conversationID(conversationId)
                .build();

        BaseResponse<ClearConversationResp> baseResponse = BaseResponse.<ClearConversationResp>builder()
                .code(0)
                .msg("success")
                .logID(Utils.TEST_LOG_ID)
                .data(clearResp)
