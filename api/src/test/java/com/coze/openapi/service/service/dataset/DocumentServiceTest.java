...
class DocumentServiceTest {
    ...
    void testCreate() throws Exception {
        ...
        CreateDocumentReq req = CreateDocumentReq.builder()
                .datasetID(dataSetID)
                .documentBases(Collections.singletonList(DocumentBase.buildWebPage("web document", "www.coze.com")))
                .build();

        CreateDocumentResp createResp = CreateDocumentResp.builder()
                .documentInfos(Arrays.asList(
                        Document.builder()
                                .documentID("123456")
                                .build()
                ))
    ...
    void testUpdate() throws Exception {
        // 准备测试数据
        UpdateDocumentReq req = UpdateDocumentReq.builder()
                .documentID(12345L)
                .documentName("updated_name")
                .build();
    ...
    void testDelete() throws Exception {
        ...
        DeleteDocumentReq req = DeleteDocumentReq.builder()
                .documentIDs(Arrays.asList(12345L, 123456L))
                .build();
    ...
    void testList() throws Exception {
        ...
        ListDocumentResp listResp = ListDocumentResp.builder()
